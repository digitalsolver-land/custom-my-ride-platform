...
```bash
git remote add encore encore://custom-my-ride-platform-ty52
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/custom-my-ride-platform-ty52/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/custom-my-ride-platform-ty52/settings/integrations/github)
